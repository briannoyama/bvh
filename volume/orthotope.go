...
func Overlaps[K Num](o0, o1 Orthotope[K]) bool {
	intersects := true
...
func Contains[K Num](o0, o1 Orthotope[K]) bool {
	contains := true
	for index, p0 := range o0.P0 {
		p1 := o0.P1[index]
...
func TaxiPath[K Num](o Orthotope[K], point [DIM]K) [DIM]K {
	coor := [DIM]K{}
	for index, p0 := range o.P0 {
		coor[index] = p0 - point[index] // Negative if within
		coor[index] = max(coor[index], 0)

		other := o.P1[index] - point[index] // Positive if within
...
func Intersects[K Num](o0, o1 Orthotope[K], d [DIM]K) float32 {
	inT := float32(0)
	outT := float32(1)
	for index, p0 := range o0.P0 {
		p1 := o0.P1[index]
...
// all others
func MinBounds[K Num](o ...Orthotope[K]) Orthotope[K] {
	minBound := o[0]

	for index, p0 := range minBound.P0 {
		p1 := minBound.P1[index]

		for _, other := range o[1:] {
			minBound.P0[index] = min(p0, other.P0[index])
			minBound.P1[index] = max(p1, other.P1[index])
		}
	}
	return minBound
}
...
func Score[K Num](o Orthotope[K]) float32 {
	var score K
	for index, p0 := range o.P0 {
		score += o.P1[index] - p0
	}
...
func Equals[K Num](o0, o1 Orthotope[K]) bool {
	return o0 == o1
}

// String representation of this orth
func String[K Num](o Orthotope[K]) string {
	return fmt.Sprintf("P0 %v, P1 %v", o.P0, o.P1)
}
