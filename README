...
<table>
  ...
  <tr>
    <td>
      <img alt="Animated steps of showing addition of volumes to the BVH" width="200" src="briannoyama.github.io/assets/images/bvh-steps/add.gif">
    </td>
    <td>
      <img alt="Animated steps of showing removal of volumes to the BVH" width="200" src="briannoyama.github.io/assets/images/bvh-steps/remove0.gif">
    </td>
    <td>
      <img alt="Animated steps of showing an alernative removal of volumes to the BVH" width="200" src="briannoyama.github.io/assets/images/bvh-steps/remove1.gif">
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>
      <img alt="Output of online algorithm for generating BVH" width="200" src="briannoyama.github.io/assets/images/bvh-steps/online.png">
    </td>
    <td>
      <img alt="Output of offline algorithm for generating BVH" width="200" src="briannoyama.github.io/assets/images/bvh-steps/offline.png">
    </td>
  </tr>
</table>
...
![Speed of adding an object per depth](briannoyama.github.io/assets/images/bvh-steps/AddRuntimePerDepth.svg)
![Speed of adding an object per number of volumes](briannoyama.github.io/assets/images/bvh-steps/AddRuntimePerSize.svg)
...
![Speed of removing an object per number of volumes](briannoyama.github.io/assets/images/bvh-steps/SubRuntimePerSize.svg)
![Speed of removing an object per depth](briannoyama.github.io/assets/images/bvh-steps/SubRuntimePerDepth.svg)
...
![Speed of querying an object per depth](briannoyama.github.io/assets/images/bvh-steps/QueryPerDepth.svg)
![Speed of querying an object per number of volumes](briannoyama.github.io/assets/images/bvh-steps/QueryPerSize.svg)
...
![Depth of the online vs offline algorithms](briannoyama.github.io/assets/images/bvh-steps/Depth.svg)
![Surface area of the online vs offline algorithms](briannoyama.github.io/assets/images/bvh-steps/SurfaceArea.svg)
